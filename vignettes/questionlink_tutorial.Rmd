---
title: "question_link_tutorial"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{question_link_tutorial}
...
In practice, this means we can harmonize all questions if at least one question is connected "to all". If we then choose this question as the target question, then all questions are harmonized (even if they themselves are only connected "to some")! There will be a clear example for this in the section [choosing the right target question].
